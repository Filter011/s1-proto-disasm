...
BGHZ_ShipMain:	; Routine 2
		...
		lea	(Ani_Eggman).l,a1
		bsr.w	AnimateSprite 				; set up animation
...
; ===========================================================================
		...
		include	"obj/sub BossDefeated & BossMove.asm"
...
GBall_MakeLinks:
		bsr.w	FindNextFreeObj				; are there any free objects?
...
GBall_Display:
		...
		bsr.w	Swing_UpdateSwingPosition		; update wrecking ball position
		bra.w	DisplaySprite
; ===========================================================================
...
GBall_Base2:	; Routine 4
		bsr.w	GBall_UpdateBase			; update base object
		bsr.w	GBall_Move				; swing wrecking ball (part of Object 15, GBall_Swing_Direction and GBall_Swing_Speed are used here)
		bra.w	DisplaySprite
...
GBall_Vanish:
		...
		movea.l	BGHZ_ParentObj(a0),a1			; copy parent object address
		tst.b	obStatus(a1)				; has Eggman's defeated flag been set (bit 7)?
		bpl.w	DisplaySprite				; if not (positive number), branch
