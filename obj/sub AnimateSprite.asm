...
AnimateSprite:
		...
		beq.s	Anim_LoadNextFrame			; if not, branch
...
Anim_SetFrameAndFlipFlags:
		...
		andi.b	#sprite_xflip|sprite_yflip,d0		; limit result to only X and Y flip state
		andi.b	#~(sprite_xflip|sprite_yflip),obRender(a0) ; clear previous X and Y flip states of objects
		lsr.b	#5,d1					; shift aniXFlip and aniYFlip into low bits to match obStatus format
