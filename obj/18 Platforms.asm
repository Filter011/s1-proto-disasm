; ===========================================================================
; ---------------------------------------------------------------------------
; Object 18 - basic platforms (GHZ, SZ, SLZ)
; ---------------------------------------------------------------------------
...
Plat_Main:	; Routine 0
		...
		move.l	#Map_Plat_SZ,obMap(a0)			; SZ-specific mappings
		move.b	#64/2,obActWid(a0)			; set SZ width (redundant, it's the same as GHZ)
	...
	.checkSLZ:
		...
		move.w	#ArtTile_SLZ_Platform|Tile_Pal3,obGfx(a0) ; set SLZ art tile
