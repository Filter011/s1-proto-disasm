...
; ===========================================================================
Moto_Index:
		dc.w	Moto_Main-Moto_Index			; 0 - initialization
...
Moto_Main:	; Routine 0
		...
		bsr.w	ObjFloorDist				; get distance between Motobug and floor
...
; ---------------------------------------------------------------------------
		...
		include	"obj/sub RememberState.asm"		; check if offscreen: display sprite if no, delete if yes

; ===========================================================================
Moto_ActIndex:
		dc.w	Moto_Action_Ledge-Moto_ActIndex		; 0 - waiting at a ledge
...
Moto_Action_Drive:
		...
		bsr.w	ObjFloorDist				; find Motobug's distance to floor
