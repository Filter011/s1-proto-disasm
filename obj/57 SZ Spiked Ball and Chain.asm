; ===========================================================================
; ---------------------------------------------------------------------------
; Object 57 - spiked balls twirling on a chain (SZ)
; ---------------------------------------------------------------------------
...
SBall_Main:	; Routine 0
		...
		move.w	#ArtTile_SZ_Spikeball_Chain,obGfx(a0)	; set art tile
		...
		move.b	#col_8x8|col_hurt,obColType(a0)		; make chain hurt Sonic
