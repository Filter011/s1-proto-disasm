...
; ===========================================================================
Mon_Index:
		dc.w	Mon_Main-Mon_Index			; 0 - init
...
; ===========================================================================
Pow_Index:
		dc.w	Pow_Main-Pow_Index			; 0 - init
...
Pow_ChkShoes:
		...
		move.w	#son_deceleration*2,(v_sonspeeddec).w 	; set Sonic's deceleration
...
Pow_ChkRings:
	...
	.chkExtraLife:
		...
		cmpi.w	#50,(v_rings).w				; check if you have at least 50 rings now
		blo.s	Pow_RingSound				; if not, branch
		bset	#0,(v_lifecount).w			; set 50 rings extra life flag
...
Mon_SolidSides:
		...
		bne.w	.no_collision				; if yes, branch
